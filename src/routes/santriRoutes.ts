...
santriRoutes.post('/', authMiddleware, isAdmin, upload.none(), santriController.create);
...
santriRoutes.put('/:id', authMiddleware, isAdminUstadSantri, upload.none(), santriController.update);
